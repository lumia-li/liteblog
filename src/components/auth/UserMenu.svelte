			...
			>
				...
				<a href="/api/auth/qq-login" class="user-dropdown-item" role="menuitem" on:click={closeMenu}>
					<svg viewBox="0 0 24 24" aria-hidden="true" width="18" height="18">
						<!-- 企鹅身体 -->
						<path fill="#12B7F5" d="M12 2.5c-3.3 0-6 2.5-6 5.6 0 1.7.6 3.2 1.6 4.3-.2 2.1-.9 4.3-1.8 6.1-.2.4 0 .9.4 1.1.3.1.6.1.9-.1 1.6-1.2 3.5-2.1 5.4-2.6l.1.1c.5.1 1 .1 1.5.1s1 0 1.5-.1l.1-.1c1.9.5 3.8 1.4 5.4 2.6.3.2.6.2.9.1.4-.2.6-.7.4-1.1-.9-1.8-1.6-4-1.8-6.1 1-1.1 1.6-2.6 1.6-4.3 0-3.1-2.7-5.6-6-5.6z"/>
						<!-- 肚皮 -->
						<path fill="#fff" d="M12 10.5c1.1 0 2 .7 2 1.6 0 .9-.9 1.6-2 1.6s-2-.7-2-1.6c0-.9.9-1.6 2-1.6z"/>
						<!-- 围巾 -->
						<path fill="#FB3B2E" d="M8 9.2c-.9.4-1.5 1.3-1.5 2.3 0 .4.1.8.2 1.2l1.3-.5V9.2zM16 9.2v3l1.3.5c.1-.4.2-.8.2-1.2 0-1-.6-1.9-1.5-2.3z"/>
						<!-- 眼睛 -->
						<circle cx="9.6" cy="11.4" r="1" fill="#1d2838"/>
						<circle cx="14.4" cy="11.4" r="1" fill="#1d2838"/>
						<!-- 嘴 -->
						<path fill="#FFB800" d="M11.3 13.3h1.4c.2 0 .3.2.2.4-.3.5-.7.8-1 .8s-.7-.3-1-.8c0-.2.1-.4.4-.4z"/>
					</svg>
					使用 QQ 登录
				</a>
